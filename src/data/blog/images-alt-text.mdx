...
```html
<img src="navigation-map.png" alt="Site navigation. Select a section to visit." usemap="#nav-map" />

<map name="nav-map">
  <area shape="rect" coords="0,0,100,50" href="/about" alt="About us" />
  <area shape="rect" coords="100,0,200,50" href="/services" alt="Our services" />
