...
thumbnail:
  light: "/images/blog/bad-focus-tab-order-example/thumbnail-light.webp"
  dark: "/images/blog/bad-focus-tab-order-example/thumbnail-dark.webp"
banner:
  light: "/images/blog/bad-focus-tab-order-example/banner-light.webp"
  dark: "/images/blog/bad-focus-tab-order-example/banner-dark.webp"
tags:
  - keyboard
---
...
_Note: this post originally included a live interactive demo of broken tab order. Rebuilding that demo as a React component is a good follow-up task once the rest of the blog is migrated._
